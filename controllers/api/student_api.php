            ...
            switch ($data['action']) {
                case 'create':
                    ...
                    if (!empty($errors)) {
                        ...
                        logError("students.php: ". implode(';', $errors));
                        exit();
                    }
                ...
                case 'delete':
                    ...
                    if ($deleted) {
                        ...
                        http_response_code(400);
                        echo json_encode(['status' => 'error', 'message' => 'Нельзя удалить студента — он связан с пропусками или оценками']);
                        logError("students.php: Нельзя удалить студента — он связан с пропусками или оценками");
                    }
                    break;
            }
            exit();
