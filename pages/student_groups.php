...
$query = mysqli_query($db_connection, "SELECT * FROM StudentGroups");
?>
        ...
        <tbody>
            <?php while ($row = mysqli_fetch_assoc($query)) : ?>
                <tr>
                    ...
                    <td>
                        <a href="edit_students.php?id=<?= $row['group_id']?>" class="edit-students-btn">Редактировать</a>
                        <form method="POST" action="students.php" style="display: inline;">
                            <input type="hidden" name="student_id" value="<?= $row['group_id']?>">
